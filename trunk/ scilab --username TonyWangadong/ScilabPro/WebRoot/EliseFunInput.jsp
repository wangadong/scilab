...
#grandbackground #global #刷新页面 #SharePage #form1 table {
...
#grandbackground #global #刷新页面 #SharePage #form1 table tr td #FonctionName {
	height: 30px;
	width: 200px;
}
#grandbackground #global #刷新页面 #SharePage #form1 table tr td #Code {
	height: 90px;
	width: 400px;
}
#grandbackground #global #刷新页面 #SharePage #form1 table tr td #Help {
	height: 90px;
	width: 400px;
}
#grandbackground #global #刷新页面 #SharePage #form1 table tr td #Exemple {
	height: 90px;
	width: 400px;
}
#Explication {
...
<div id="大图">
  <div id="NewFonction">
    <table width="189" height="202" border="0">
      <tr>
        <td>最新方程：</td>
      </tr>
      <tr>
